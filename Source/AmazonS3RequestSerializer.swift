...
public class AmazonS3RequestSerializer {
    ...
    */
    ...
    private func setAuthorizationHeaders(inout forRequest request: NSMutableURLRequest) {
        ...
        request.setValue(AWSV4SignatureCalculator.payloadHash(request: request), forHTTPHeaderField: "x-amz-content-sha256")
        request.setValue(currentTimeStamp() ?? "", forHTTPHeaderField: "x-amz-date")
